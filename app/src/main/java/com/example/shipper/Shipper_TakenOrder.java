...
public class Shipper_TakenOrder extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_home = findViewById(R.id.btn_shipper_home2);
        btn_takenOrder = findViewById(R.id.btn_shipper_takenOrder2);
        btn_deliveringOrder = findViewById(R.id.btn_deliveringOrder2);
        btn_shipperHistory = findViewById(R.id.btn_shipper_history2);
        btn_shipperProfile = findViewById(R.id.btn_shipper_profile2);
        btnBAck = findViewById(R.id.btn_back_takenOrder);
        listView = findViewById(R.id.shipper_taken_listView);
...
//        startActivity(intent);
        Intent intent;
        switch (v.getId()) {
            case R.id.btn_shipper_home2:
                intent = new Intent(Shipper_TakenOrder.this, Shipper_home.class);
                startActivity(intent);
                break;
            case R.id.btn_deliveringOrder2:
                intent = new Intent(Shipper_TakenOrder.this, Shipper_DeliveryOrder.class);
                startActivity(intent);
                break;
            case R.id.btn_shipper_history2:
                intent = new Intent(Shipper_TakenOrder.this, Shipper_History.class);
                startActivity(intent);
                break;
            case R.id.btn_shipper_profile2:
                intent = new Intent(Shipper_TakenOrder.this, Shipper_Profile.class);
                startActivity(intent);
                break;
            case R.id.btn_back_takenOrder:
                intent = new Intent(Shipper_TakenOrder.this, Shipper_home.class);
                startActivity(intent);
                break;
...
//        });
    ...
    public void btnNhanGiao(LinearLayout button) {
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
